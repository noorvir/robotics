...
% set parameters for ikine function using pinv
% set tol as a percentage of minimum error possible based on workspace range
tol = 0.05; 
alpha = 0.005;
theta_ikine = inverse_kine_PCRT(planar_traj, planar4Rrobot, alpha, tol, 'q1');
